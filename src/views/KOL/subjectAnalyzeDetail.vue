<template>
  <div class="container">
      ...
      <el-form ref="form" :model="sizeForm" label-width="120px" size="mini" label-position="left">
        ...
        <el-form-item label="类 型：">
          <el-radio-group v-model="radio" fill="#67c23a">
            <el-radio-button label="增量图"></el-radio-button>
            <el-radio-button label="总量图"></el-radio-button>
          </el-radio-group>
        </el-form-item>
      </el-form>
    ...
    <div class="bottom_video">
      ...
      <el-button type="success" plain>点赞数</el-button>
      <el-button type="success" plain>粉丝数</el-button>
      <el-button type="success" plain>发布时间</el-button>
